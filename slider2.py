...
class Slider2(Widget):
    ...
    var1 = analogInputs.calculatedVar1
    var2 = analogInputs.calculatedVar2
    var3 = analogInputs.calculatedVar3
    var4 = analogInputs.calculatedVar4
    var5 = analogInputs.calculatedVar5

    sliderHeight = 250

    horizontalHintRatio = .20
    ...
    def set_norm_value1(self, value):
        ...
        if self.value1 > self.value2: self.value2 = self.value1 + 5
